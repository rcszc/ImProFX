...
namespace IMPROFX_LOW {
	// improfx framework lowlayer graphic dataset.
	...
	protected:
		// resource data(lowlayer_resource).
		...
		void LowLayerResourceCreate(RendererLogger LogFunc, uint32_t ResTMU = 32);
		bool LowLayerResourceFree();
	};
}
constexpr const char* LLRES_ADCHAR = "__";
