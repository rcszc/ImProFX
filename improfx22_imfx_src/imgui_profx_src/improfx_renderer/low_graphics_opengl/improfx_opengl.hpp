...
#define IMFX_OGLMAG_LABEL "[imfx_opengl_mag]: "
...
// Resource Module (Renderer"Resource"Interface)
// Update: 2023.12.30 RCSZ.
namespace IMFX_OGL_RES {
#define IMFX_OGLRES_LABEL "[imfx_opengl_res]: "
	...
	public:
		...
		// VBO持久映射(用于动态更新,非标准接口) update: 2023.12.31
