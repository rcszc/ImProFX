...
class FSloadModelData :public IFC_SHADER::ShaderVertString {
protected:
...
// default ortho matrix length.
constexpr float ShaderDefaultOrthoLen = 10.0f;
...
protected:
	uint32_t FrameBufferHandle = NULL;
public:
	FSloadFrameBuffer();
