...
- __当前:__ 因为耦合程度太高, 提前进行渲染抽象层开发, 希望你能友好的提出建议, __我也是在摸索中学习__
> 具体参见Demo和文档, 预计2.2.0 ALPHA在2024年1~2月更新.

- __下一次大更新:__ 3.0.0 ALPHA 渲染抽象层(IPFX-GL), GUI控件抽象层(IPFX-UI)
> 预计: 2024年5月~9月 架构: IMPROFX-PM-IPFXGL 兼容图形底层: OpenGL Vulkan, 架构图会在这之前公布...
