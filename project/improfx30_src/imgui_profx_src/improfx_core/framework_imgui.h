...
namespace ImGuiPro {
	...
	void FullScreenImWindowBg(ImTextureID texture_hd, const bool& draw_fps = true);
	...
	public:
		...
		void PRO_FloatingWindowImage(ImTextureID texture_hd, const ImVec2& size = ImVec2(96.0f, 96.0f));
