...
#define FS_VERTEX_LENGTH  FS_VERTEX_ELEMENT + FS_VERTEX_COORD + FS_VERTEX_COLOR + FS_VERTEX_TEXUV
#define FS_VERTEX_BYTES  (FS_VERTEX_ELEMENT + FS_VERTEX_COORD + FS_VERTEX_COLOR + FS_VERTEX_TEXUV) * sizeof(float)
